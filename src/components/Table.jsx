  ...
  return (
    <div class="flex flex-col gap-2 flex-wrap bg-violet-300 items-center p-6">
      ...
      <div className="flex flex-row gap-2">
        {" "}
        <div
          class="h-10 w-10 sm:h-16 sm:w-20 border p-1 text-center text-4xl rounded-sm"
          id="1"
          onClick={() => handleClick(1)}
        ></div>
        <div
          class="h-10 w-10 sm:h-16 sm:w-20 border p-1  text-4xl text-center"
          id="2"
      ...
      <div className="flex flex-row gap-2">
        ...
        ></div>
        <div
          class="h-10 w-10 sm:h-16 sm:w-20 text-4xl  border p-1 text-center"
          id="14"
      ...
      <div className="flex flex-row gap-2">
        ...
        ></div>
        <div
          class="h-10 w-10 sm:h-16 sm:w-20  border  text-4xl p-1 text-center"
          id="18"
